...
const t = {
  en: {
    ...
    heroSub: "Photo Studio in Zurich for Photographers, Brands & Content Creators",
    intro: "Rent a Photo Studio in Zurich",
    introP: "Modern daylight studio with professional equipment for portrait, beauty, fashion, branding and product photography. Flexible booking from one hour.",
    heroCta: "Ready for Your Next Shoot?",
    spaceH2: "The Studio",
    spaceLink: "Explore More →",
    bookTag: "Book Your Slot",
    bookH2: "Create. Shoot. Elevate.",
    bookP1: "Rent a modern daylight studio with professional equipment, minimal design and flexible online booking.",
    bookP2: "Check real-time availability and book your studio in a few clicks for your next shoot.",
    bookCta: "Book Now",
  },
  de: {
    heroTitle: "CEE Studio",
    heroSub: "Fotostudio Zürich für Fotografen, Marken & Content Creator",
    intro: "Fotostudio Zürich mieten",
    introP: "Modernes Tageslichtstudio mit professionellem Equipment für Portrait, Beauty, Fashion, Branding und Produktfotografie. Flexible Buchung ab einer Stunde.",
    heroCta: "Bereit für Ihr nächstes Shooting?",
    spaceH2: "Das Studio",
    spaceLink: "Mehr entdecken →",
    bookTag: "Termin sichern",
    bookH2: "Create. Shoot. Elevate.",
    bookP1: "Mieten Sie ein modernes Tageslichtstudio mit professionellem Equipment, minimalistischem Design und flexibler Online-Buchung.",
    bookP2: "Prüfen Sie die Verfügbarkeit in Echtzeit und reservieren Sie Ihr Studio in wenigen Klicks für Ihr nächstes Shooting.",
    bookCta: "Jetzt buchen",
  },
  fr: {
    heroTitle: "CEE Studio",
    heroSub: "Studio photo à Zurich pour photographes, marques & créateurs",
    intro: "Louer un studio photo à Zurich",
    introP: "Studio à lumière naturelle moderne avec équipement professionnel pour portrait, beauté, mode, branding et photographie produit. Réservation flexible dès une heure.",
    heroCta: "Prêt pour votre prochain shooting ?",
    spaceH2: "Le Studio",
    spaceLink: "Découvrir plus →",
    bookTag: "Réservez votre créneau",
    bookH2: "Create. Shoot. Elevate.",
    bookP1: "Louez un studio à lumière naturelle moderne avec équipement professionnel, design minimaliste et réservation en ligne flexible.",
    bookP2: "Vérifiez la disponibilité en temps réel et réservez votre studio en quelques clics pour votre prochain shooting.",
    bookCta: "Réserver",
  },
  it: {
    heroTitle: "CEE Studio",
    heroSub: "Studio fotografico a Zurigo per fotografi, brand & creator",
    intro: "Affitta uno studio fotografico a Zurigo",
    introP: "Studio moderno a luce naturale con attrezzatura professionale per ritratto, beauty, moda, branding e fotografia di prodotto. Prenotazione flessibile da un'ora.",
    heroCta: "Pronto per il tuo prossimo shooting?",
    spaceH2: "Lo Studio",
    spaceLink: "Scopri di più →",
    bookTag: "Prenota il tuo slot",
    bookH2: "Create. Shoot. Elevate.",
    bookP1: "Affitta uno studio moderno a luce naturale con attrezzatura professionale, design minimalista e prenotazione online flessibile.",
    bookP2: "Controlla la disponibilità in tempo reale e prenota il tuo studio in pochi clic per il tuo prossimo shooting.",
    bookCta: "Prenota ora",
  },
};
      ...
      <section className="relative h-screen w-full overflow-hidden">
        <div className="absolute inset-0 grain-overlay">
          <Image
            ...
            alt="Fotostudio Zürich — CEE Studio Lounge mit Aussicht, Cowhide-Teppich und Tageslicht"
            fill
