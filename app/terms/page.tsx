  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Weekday bookings, more than 48 hours before: free cancellation, full refund (minus payment processing fees)",
          "Weekday bookings, between 24 and 48 hours before: 50% of the booking amount is charged",
          "Weekday bookings, less than 24 hours before: 100% of the booking amount is charged",
          "Weekend bookings: non-refundable in all cases",
          "Missed bookings or no-shows: charged in full (100%)",
        ],
      },
      {
  ...
  de: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Werktags-Buchungen, mehr als 48 Stunden vorher: kostenlose Stornierung, volle Rückerstattung (abzüglich Zahlungsbearbeitungsgebühren)",
          "Werktags-Buchungen, zwischen 24 und 48 Stunden vorher: 50% des Buchungsbetrags werden in Rechnung gestellt",
          "Werktags-Buchungen, weniger als 24 Stunden vorher: 100% des Buchungsbetrags werden in Rechnung gestellt",
          "Wochenend-Buchungen: in allen Fällen nicht erstattungsfähig",
          "Versäumte Buchungen oder Nichterscheinen: voll berechnet (100%)",
        ],
      },
      {
  ...
  fr: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Réservations en semaine, plus de 48 heures avant : annulation gratuite, remboursement complet (moins les frais de traitement)",
          "Réservations en semaine, entre 24 et 48 heures avant : 50% du montant facturés",
          "Réservations en semaine, moins de 24 heures avant : 100% du montant facturés",
          "Réservations en week-end : non remboursables dans tous les cas",
  ...
  it: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Prenotazioni infrasettimanali, più di 48 ore prima: cancellazione gratuita, rimborso completo (meno spese di elaborazione)",
          "Prenotazioni infrasettimanali, tra 24 e 48 ore prima: viene addebitato il 50% dell'importo",
          "Prenotazioni infrasettimanali, meno di 24 ore prima: viene addebitato il 100% dell'importo",
          "Prenotazioni nel weekend: non rimborsabili in tutti i casi",
