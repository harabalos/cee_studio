...
const specs = {
  en: [
    ...
    { title: "Backdrops", value: "Paper Rolls", desc: "White, Black & Beige seamless · CHF 20 per used meter" },
  ...
  de: [
    ...
    { title: "Hintergründe", value: "Papierrollen", desc: "Weiss, Schwarz & Beige nahtlos · CHF 20 pro verbrauchtem Meter" },
  ...
  fr: [
    ...
    { title: "Fonds", value: "Rouleaux Papier", desc: "Blanc, Noir & Beige sans couture · CHF 20 par mètre utilisé" },
  ...
  it: [
    ...
    { title: "Sfondi", value: "Rotoli Carta", desc: "Bianco, Nero & Beige senza giunte · CHF 20 per metro utilizzato" },
  ...
  fr: [
    {
      ...
      features: [
        ...
        "1 couleur de fond incluse par session",
        "Équipement premium +CHF 40",
      ],
      popular: false,
    },
    {
      ...
      features: [
        ...
        "Équipement standard inclus",
        "Jusqu'à 2 couleurs de fond incluses par session",
        "Équipement premium +CHF 25",
      ],
      popular: true,
    },
    {
      ...
      features: [
        ...
        "Accès prioritaire",
        "Équipement standard inclus",
        "Toutes les couleurs de fond incluses",
  ...
  it: [
    {
      ...
      features: [
        "4h / mese",
        "Attrezzatura standard inclusa",
        "1 colore di sfondo incluso per sessione",
        "Attrezzatura premium +CHF 40",
      ],
      popular: false,
    },
    {
      ...
      features: [
        ...
        "Attrezzatura standard inclusa",
        "Fino a 2 colori di sfondo inclusi per sessione",
        "Attrezzatura premium +CHF 25",
      ],
      popular: true,
    },
    {
      ...
      features: [
        ...
        "Accesso prioritario",
        "Attrezzatura standard inclusa",
        "Tutti i colori di sfondo inclusi",
        "Attrezzatura premium inclusa",
      ],
      popular: false,
    },
  ],
