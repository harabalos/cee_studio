...
const T = {
  de: {
    ...
    door_code: "Locker-Code",
    wifi: "WLAN",
    no_codes: "Den Locker-Code senden wir dir 24h vor dem Termin separat zu.",
  ...
  en: {
    ...
    door_code: "Locker code",
    wifi: "WiFi",
    no_codes: "We'll send the locker code 24h before your booking.",
  ...
  fr: {
    ...
    door_code: "Code casier",
    wifi: "WiFi",
    no_codes: "Nous t'enverrons le code du casier 24h avant la réservation.",
  ...
  it: {
    ...
    door_code: "Codice armadietto",
    wifi: "WiFi",
    no_codes: "Ti invieremo il codice armadietto 24h prima della prenotazione.",
