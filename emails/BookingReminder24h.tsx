...
const T = {
  de: {
    ...
    sections: (code: string, premium: boolean): Section[] => [
      ...
      ...(!premium ? [{
        icon: "📡",
        title: "Trigger nicht vergessen",
        body: "Für das Standard Package: Bitte denkt daran, den passenden Trigger für eure Kamera mitzubringen, um die Studio-Beleuchtung nutzen zu können.",
      }] : []),
    ],
  ...
  en: {
    ...
    sections: (code: string, premium: boolean): Section[] => [
      ...
      ...(!premium ? [{
        icon: "📡",
        title: "Don't forget your trigger",
        body: "For the Standard Package: please remember to bring the appropriate trigger for your camera to use the studio lighting.",
      }] : []),
    ],
  ...
  fr: {
    ...
    sections: (code: string, premium: boolean): Section[] => [
      ...
      ...(!premium ? [{
        icon: "📡",
        title: "N'oublie pas le trigger",
        body: "Pour le forfait Standard : merci de penser à apporter le déclencheur adapté à ton appareil photo, pour pouvoir utiliser l'éclairage du studio.",
      }] : []),
    ],
  ...
  it: {
    ...
    sections: (code: string, premium: boolean): Section[] => [
      ...
      ...(!premium ? [{
        icon: "📡",
        title: "Non dimenticare il trigger",
        body: "Per il pacchetto Standard: ricordati di portare il trigger adatto alla tua fotocamera per poter utilizzare l'illuminazione dello studio.",
      }] : []),
    ],
